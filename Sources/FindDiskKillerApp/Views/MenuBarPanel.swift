...
struct MenuBarPanel: View {
    ...
    var body: some View {
        ...
        .onTapGesture(perform: openMainWindow)
        .accessibilityElement(children: .contain)
        .accessibilityAction(named: Text(L10n.text("打开 FindDiskKiller")), openMainWindow)
        // Do not set .help on the whole panel — it steals tooltips from the
        // collection / quit controls. Buttons carry their own help text.
    }
