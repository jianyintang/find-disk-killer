<div align="center">
  ...
  <p>
    <a href="https://github.com/jianyintang/find-disk-killer/releases/latest">下载</a> ·
...
- **设备吞吐** 来自物理设备计数器，并通过 `Macintosh HD`、`JianDisk` 等卷名呈现。
...
正式版本以 Developer ID 签名、Apple 公证的 universal2 DMG 提供：

1. 从 [Releases](https://github.com/jianyintang/find-disk-killer/releases/latest) 下载最新版。
...
FindDiskKiller 采用仓库中的 [All Rights Reserved 许可](LICENSE)。第三方应用标识仅用于识别
被观察的软件，不代表合作、认可或背书。
